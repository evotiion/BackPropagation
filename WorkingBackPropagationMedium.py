...
for x in range(1,500):
    ...
    w3Actual = -1.22
    w4Actual = -2.3
    yvals[0] = calcNN(xpoints[0],b3Actual,w3Actual,w4Actual)
    yvals[1] = calcNN(xpoints[1],b3Actual,w3Actual,w4Actual)
    yvals[2] = calcNN(xpoints[2],b3Actual,w3Actual,w4Actual)
    yvals[3] = calcNN(xpoints[3],b3Actual,w3Actual,w4Actual)
    yvals[4] = calcNN(xpoints[4],b3Actual,w3Actual,w4Actual)
    yvals[5] = calcNN(xpoints[5],b3Actual,w3Actual,w4Actual)
    yvals[6] = calcNN(xpoints[6],b3Actual,w3Actual,w4Actual)
    yvals[7] = calcNN(xpoints[7],b3Actual,w3Actual,w4Actual)
    yvals[8] = calcNN(xpoints[8],b3Actual,w3Actual,w4Actual)
    yvals[9] = calcNN(xpoints[9],b3Actual,w3Actual,w4Actual)
    yvals[10] = calcNN(xpoints[10],b3Actual,w3Actual,w4Actual)
